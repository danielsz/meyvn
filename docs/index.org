...
#+begin_src shell
mvn org.apache.maven.plugins:maven-dependency-plugin:2.1:get -DrepoId=sapiens -DrepoUrl=https://nexus.tuppu.net/repository/sapiens/ -Dartifact=org.danielsz:meyvn-pro:1.3.1
#+end_src
...
| [INFO] | Finished                                                                 | at:                             | 2020-02-02T02:37:19-08:00          |         |                |      |   |
| [INFO] | ------------------------------------------------------------------------ |                                 |                                    |         |                |      |   |
...
#!/bin/sh
M2_HOME=/usr/share/maven java -jar ~/.m2/repository/org/danielsz/meyvn/1.3.1/meyvn-1.3.1.jar "$@"
#+END_SRC
