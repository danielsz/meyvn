...
#+begin_src sh
clj -Sdeps '{:deps {org.danielsz/meyvn-installer {:mvn/version "1.2.6"}}}' -m meyvn-installer.core
#+end_src
...
#!/bin/sh
M2_HOME=/usr/share/maven java -jar ~/.m2/repository/org/danielsz/meyvn/1.4.8/meyvn-1.4.8.jar "$@"
#+END_SRC
