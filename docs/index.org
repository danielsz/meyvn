...
#+begin_src sh
clj -Sdeps '{:deps {org.meyvn/meyvn-installer {:mvn/version "1.3.8"}}}' -M -m meyvn-installer.core
#+end_src
...
#+begin_src shell
mvn org.apache.maven.plugins:maven-dependency-plugin:3.2.0:get -DremoteRepositories=https://nexus.tuppu.net/repository/meyvn/ -Dartifact=org.meyvn:meyvn:1.6.1
#+end_src
...
#!/bin/sh
M2_HOME=/path/to/maven/root java -jar ~/.m2/repository/org/meyvn/meyvn/1.6.2/meyvn-1.6.2.jar "$@"
#+END_SRC
