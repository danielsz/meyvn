...
#+begin_src shell
mvn org.apache.maven.plugins:maven-dependency-plugin:2.1:get -DrepoId=sapiens -DrepoUrl=https://nexus.tuppu.net/repository/sapiens/ -Dartifact=org.danielsz:meyvn-pro:1.4.2
#+end_src
