...
#+begin_src sh
clj -Sdeps '{:deps {org.meyvn/meyvn-installer {:mvn/version "1.4.4"}}}' -M -m meyvn-installer.core
#+end_src
...
#!/bin/sh
M2_HOME=/path/to/maven/root java -jar ~/.m2/repository/org/meyvn/meyvn/1.6.7/meyvn-1.6.7.jar "$@"
#+END_SRC
