...
#+begin_src sh
clj -Sdeps '{:deps {org.danielsz/meyvn-installer {:mvn/version "1.1.4"}}}' -m meyvn-installer.core
#+end_src
...
#+begin_src shell
mvn org.apache.maven.plugins:maven-dependency-plugin:2.1:get -DrepoId=sapiens -DrepoUrl=https://nexus.tuppu.net/repository/sapiens/ -Dartifact=org.danielsz:meyvn-pro:1.3.4
#+end_src
