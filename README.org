...
The [[https://github.com/danielsz/NoLipService][NoLipService]] library is responsible for the analytics. To ensure transparency it is released as open source as well. It is still early days, and I welcome contributions and more implementation ideas. 

If you'd like to license a commercial version which doesn't collect data, please refer to the license section at the bottom of the README.

The community version will always remain free and available to all parties.
