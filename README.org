...
The takeaway for Meyvn is that building on top of the Maven ecosystem is rewarding. It is a huge ecosystem, well documented and extremely mature. A lot of functionality just sits there, waiting to be tapped by a tool like Meyvn. Things like continuous integration, generated documentation, testing, reporting, etc.
