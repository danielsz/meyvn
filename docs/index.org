...
#+begin_src sh
clj -Sdeps '{:deps {org.meyvn/meyvn-installer {:mvn/version "1.4.0"}}}' -M -m meyvn-installer.core
#+end_src
...
#+begin_src shell
mvn org.apache.maven.plugins:maven-dependency-plugin:3.2.0:get -DremoteRepositories=https://nexus.tuppu.net/repository/meyvn/ -Dartifact=org.meyvn:meyvn:1.6.3
#+end_src
...
#!/bin/sh
M2_HOME=/path/to/maven/root java -jar ~/.m2/repository/org/meyvn/meyvn/1.6.3/meyvn-1.6.3.jar "$@"
#+END_SRC
