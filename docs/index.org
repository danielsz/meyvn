...
#+begin_src sh
clj -Sdeps '{:deps {org.danielsz/meyvn-installer {:mvn/version "1.3.1"}}}' -M -m meyvn-installer.core
#+end_src
...
#+begin_src shell
mvn org.apache.maven.plugins:maven-dependency-plugin:2.1:get -DrepoId=meyvn -DrepoUrl=https://nexus.tuppu.net/repository/meyvn/ -Dartifact=org.danielsz:meyvn-pro:1.5.5
#+end_src
...
#!/bin/sh
M2_HOME=/usr/share/maven java -jar ~/.m2/repository/org/danielsz/meyvn/1.5.5/meyvn-1.5.5.jar "$@"
#+END_SRC
