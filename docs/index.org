...
#+begin_src shell
mvn org.apache.maven.plugins:maven-dependency-plugin:2.1:get -DrepoId=sapiens -DrepoUrl=https://nexus.tuppu.net/repository/sapiens/ -Dartifact=org.danielsz:meyvn-pro:1.3.2
#+end_src
...
#!/bin/sh
M2_HOME=/usr/share/maven java -jar ~/.m2/repository/org/danielsz/meyvn/1.3.2/meyvn-1.3.2.jar "$@"
#+END_SRC
