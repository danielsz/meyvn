...
#+begin_src sh
clj -Sdeps '{:deps {org.danielsz/meyvn-installer {:mvn/version "1.3.3"}}}' -M -m meyvn-installer.core
#+end_src
...
#+begin_src shell
mvn org.apache.maven.plugins:maven-dependency-plugin:3.2.0:get -DremoteRepositories=https://nexus.tuppu.net/repository/meyvn/ -Dartifact=org.danielsz:meyvn-pro:1.5.7
#+end_src
...
#!/bin/sh
M2_HOME=/usr/share/maven java -jar ~/.m2/repository/org/danielsz/meyvn/1.5.7/meyvn-1.5.7.jar "$@"
#+END_SRC
