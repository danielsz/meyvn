...
Meyvn doesn't want to force you to install clojure or Meyvn on your servers, but if you do, you can use it to list those properties and pipe into a script that will massage the properties into environment variables, or such like. How you use them depends on your final command output. The last mile is context-dependent.
